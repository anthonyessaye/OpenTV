...
class _MobileDetailState extends State<MobileDetail> {
  ...
  /// What to call one episode. The rule is in core, beside the television's
  /// copy of this question and the player's.
  String _labelFor(Episode episode) => episodeLabel(
        title: episode.title,
